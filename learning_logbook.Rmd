...
```{r}
positions_in_station_list<-c(1,2,10)
...
?names
#Error in names(patch_weather) <- `*vtmp*` : 
...
patched<-patch_daily_temperatures(weather = fixed_weather,
...
```{r}
fixed_weather <- fix_weather(patched)
fixed_weather$QC
```
