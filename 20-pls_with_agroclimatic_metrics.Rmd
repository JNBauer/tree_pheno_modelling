...
title <- "Extract of the coefficients from the PLS analysis"
...
```{r, echo=FALSE, fig.cap="Daily chill and heat accumulation rates plot as part for the final graph"}
temp_plot
```
...
```{r, echo=FALSE, fig.cap="VIP scores plotted and used as part for the final graph"}
VIP_plot
```
...
```{r, echo=FALSE, fig.cap="Model coefficients plotted for the use in the final graph"}
coeff_plot
```
...
```{r, echo=FALSE, fig.cap="Final result with all three subplots patched together"}
plot
```

I hid the code for the `plot_PLS_chill_force()` function behind the button below to save some space.
\
...
<button title="Click to show/hide the code for the modified function" type="button"
...
\
```{r, message=FALSE, warning=FALSE, fig.cap="PLS regression plot for the response of the Chilling Hours model and GDH model for ‘Roter Boskoop’ apples at CKA"}
plot_PLS_chill_force(plscf,
                     ...
                     chill_phase=c(0,0),
                     heat_phase=c(8,106),
                     plot_title = "Chilling Hours model")
```
\
```{r, message=FALSE, warning=FALSE, fig.cap="PLS regression plot for the response of the Utah Chill model and GDH model for ‘Roter Boskoop’ apples at CKA"}
plot_PLS_chill_force(plscf,
                     ...
                     chill_phase=c(-13,65),
                     heat_phase=c(8,108),
                     plot_title = "Utah Chill model")
```
\
```{r, message=FALSE, warning=FALSE, fig.cap="PLS regression plot for the response of the Dynamic Model and GDH model for ‘Roter Boskoop’ apples at CKA"}
plot_PLS_chill_force(plscf,
                     chill_metric="Chill_Portions",
                     heat_metric="GDH",
                     chill_label="CP",
